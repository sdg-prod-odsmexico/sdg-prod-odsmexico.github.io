...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"disaggregation_controls":true,"minZoom":5,"maxZoom":10,"tileURL":"","tileOptions":{"id":"","accessToken":"","attribution":""},"colorRange":"myMapColorFunction","noValueColor":"#f0f0f0","styleNormal":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#888888","dashArray":""},"styleHighlighted":{"weight":1,"opacity":1,"fillOpacity":0.7,"color":"#111111","dashArray":""},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":"#172d44","dashArray":"5,5"}},
      mapLayers: [{"subfolder":"map/entidades-federativas","label":"indicator.map","min_zoom":0,"max_zoom":6,"staticBorders":true},{"subfolder":"map/municipios","label":"indicator.map","min_zoom":7,"max_zoom":20,"staticBorders":false}],
      precision: precision,
